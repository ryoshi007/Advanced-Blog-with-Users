...
load_dotenv("C:/Users/Freyr/PycharmProjects/.env.txt")
...
# Normally child will has an id to store its parent's id
    ...
    if request.method == "POST":
        if login_form.validate_on_submit():
            ...
            if not user:
                ...
                return redirect(url_for('login'))
            elif not check_password_hash(user.password, password=login_form.password.data):
